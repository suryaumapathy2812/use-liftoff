  ...
  useEffect(() => {
    const loadReport = async () => {
      try {
        ...
        const response = await import(`@/data/interview-reports/${reportId}.json`);
        setReport(response.default);
      } catch (err) {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#F2F3F5] flex items-center justify-center">
        ...
        >
          <FileText className="w-16 h-16 text-[#407BBF] mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-[#1E2B3A] mb-2">Loading Report</h2>
          <p className="text-[#1a2b3b]">Retrieving your interview analysis...</p>
        </motion.div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#F2F3F5] flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-[#1E2B3A] mb-2">Report Not Found</h2>
          <p className="text-[#1a2b3b] mb-6">The requested interview report could not be found.</p>
          <Link href="/~/reports">
            <button className="rounded-full px-6 py-3 text-[14px] font-semibold transition-all flex items-center justify-center bg-[#1E2B3A] text-white hover:bg-[#2a3a4d] no-underline gap-x-2 active:scale-95 scale-100 duration-75 mx-auto">
  ...
  return (
    <div className="min-h-screen bg-[#F2F3F5] py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Link href="/~/reports">
            <button className="flex items-center gap-2 text-[#407BBF] hover:text-[#2a3a4d] transition-colors">
              <ArrowLeft className="w-4 h-4" />
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-xl p-8 text-white">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-blue-100 max-w-2xl mx-auto">
                ...
                in your {Math.round(report.session.duration / 60)}-minute session with {report.interviewer.name}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                {Object.entries(report.behavioralAnalysis.emotionalState)
                  ...
                  .map(([emotion, value]) => (
                    <div key={emotion} className="p-3 bg-purple-50 rounded-lg">
                      ...
                      <div className="text-lg font-bold text-[#6366F1]">{value as number}%</div>
                    </div>
                  ))}
              </div>

              <div className="space-y-2">
                {report.behavioralAnalysis.insights.slice(0, 2).map((insight: string, index: number) => (
            ...
            <div>
              ...
              <div className="space-y-2">
                {report.speechAnalysis.insights.slice(0, 2).map((insight: string, index: number) => (
                  <div key={index} className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="space-y-2">
                {report.fieldKnowledgeEvaluation.insights.slice(0, 2).map((insight: string, index: number) => (
                  <div key={index} className="flex items-start gap-2">
              ...
              >
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {report.behavioralAnalysis.insights.map((insight: string, index: number) => (
            ...
            {activeTab === 'speech' && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {report.speechAnalysis.insights.map((insight: string, index: number) => (
            ...
            {activeTab === 'knowledge' && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {report.fieldKnowledgeEvaluation.insights.map((insight: string, index: number) => (
                      <div key={index} className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2">
                {report.reportSummary.strengths.map((strength: string, index: number) => (
            ...
            <div>
              ...
              <ul className="space-y-2">
                {report.reportSummary.areasForImprovement.map((area: string, index: number) => (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {report.reportSummary.nextSteps.map((step: string, index: number) => (
